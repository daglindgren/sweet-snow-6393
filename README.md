...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/sweet-snow-6393)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-snow-6393
```

A live public deployment of this template is available at [https://sweet-snow-6393.templates.workers.dev](https://sweet-snow-6393.templates.workers.dev)
